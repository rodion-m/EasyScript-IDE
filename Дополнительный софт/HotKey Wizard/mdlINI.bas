...
Public Const SETTINGS_FILENAME = "ESM.ini"
...
Public Function ReadIni(ByVal strKeyName As String, Optional ByVal strDefault As String, Optional iniSection As String = "Main", Optional TypeOfData As TypeOfData = -1, Optional iniFile As String) As String
