...
Function GetFileBaseName(ByVal FileName As String, Optional Slash As String = "\") As String
    Dim lngSlashPos As Long
    lngSlashPos = InStrRev(FileName, Slash)
...
Function IsFileExists(ByVal FileName As String) As Boolean
    ...
    If Err.Number = 53 Or Err.Number = 52 Or Err.Number = 76 Or Err.Number = 75 Then
        Err.Clear
       Exit Function
    End If
    Close fn
...
Sub CheckFileName(ByRef FileName As String)
    If InStr(1, FileName, "\") = 0 Then
        FileName = LoadedFile.Path & FileName
    End If
End Sub
